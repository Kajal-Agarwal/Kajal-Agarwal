...
banner() {
    ...
    if ! [ -x "$(command -v figlet)" ]; then
        echo 'Introducing GD-Bomb'
    else
        figlet GD-Bomb
    fi
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This GD-Bomber Was Created By \e[1;32m😈 GD THE HACKER 😈 \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;34m"
        toilet -f mono12 -F border 😈 GD THE HACKER 😈
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m           Telegram: t.me@GD_HACKE \e[0m"
    echo -e "\e[4;32m   YouTube: https://www.youtube.com/c/SpeedXTech \e[0m"
    echo " "
    echo "NOTE: Kindly move to the PIP version Of GD-Bomb for more stability."
    echo " "
}
...
if [ -f .update ];then
    ...
    echo .
    install_deps
    echo This Script Was Made By 😈 GD THE HACKER 😈 > .update
...
do
    ...
    if [ $ch -eq 1 ];then
        ...
        echo -e "\e[1;34m RUN GD-Bomb Again..."
        pause
        exit
    elif [ $ch -eq 5 ];then
        banner
